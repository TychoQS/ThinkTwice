export default {
  ...
  questionnaire: {
    ...
    result: {
      ...
      decisionPrompt: 'What did you decide?',
      decisionBought: 'I bought it',
      decisionSkipped: "I didn't buy it",
      decisionPending: 'Still deciding',
      decisionLogged: 'Decision recorded',
    },
    profileModal: {
    ...
    profiles: {
      impulsive: {
        ...
        subtitle: 'Emotion-driven',
        description: 'Your buying decisions are largely driven by emotions and impulses. You tend to buy things in the heat of the moment, often triggered by excitement, boredom, or stress.',
        tip1: 'Apply a 24-48 hour rule before any purchase',
        tip2: 'Ask yourself: "Am I buying this because I need it or because I feel something?"',
        tip3: 'Remove saved payment info to create friction before buying',
      },
      dealHunter: {
        label: 'Deal Hunter',
        subtitle: 'Discount-driven',
        description: 'You are attracted to deals and discounts. While being budget-conscious is good, the thrill of "saving" can lead to buying things you would not otherwise want.',
        tip1: 'Ask: "Would I buy this at full price?" — if not, it is not a real need',
        tip2: 'Calculate what you are SPENDING, not what you are saving',
        tip3: 'Unsubscribe from promotional emails to reduce temptation',
      },
      functional: {
        label: 'Functional Buyer',
        subtitle: 'Need-driven',
        description: 'You buy based on practical need. Your purchases are generally well-considered, but you may sometimes over-engineer solutions or upgrade unnecessarily.',
        tip1: 'Verify your current solution truly cannot meet the need',
        tip2: 'Check if a simpler or cheaper alternative exists',
        tip3: 'Quantify the actual time or money saved by the new purchase',
      },
      budgetConstrained: {
        label: 'Budget-Conscious',
        subtitle: 'Financially mindful',
        description: 'You are very aware of your financial limits. This makes you cautious, but financial anxiety can sometimes push impulsive "last chance" purchases.',
        tip1: 'Write down how this fits your current monthly budget',
        tip2: 'Delay the purchase until your next budget period if unsure',
        tip3: 'Ask yourself if this aligns with your top financial goal',
      },
    },
    profileQuestions: {
      impulsive: {
  ...
  premium: {
    menuLabel: 'Go Premium',
    premiumLabel: 'Premium ✓',
    title: 'ThinkTwice Premium',
    subtitle: 'Unlock the full experience',
    price: '$2.99 / month',
    feature1Title: 'Smarter AI',
    feature1Desc: 'Powered by a more capable model for deeper, more nuanced insights',
    feature2Title: 'Priority Access',
    feature2Desc: 'Faster responses and no rate limits',
    feature3Title: 'Extended Memory',
    feature3Desc: 'AI remembers more of your shopping history to personalise advice',
    feature4Title: 'All Future Features',
    feature4Desc: 'Be first to access every new feature we add',
    subscribeButton: 'Subscribe Now',
    restoreButton: 'Restore Purchase',
    activeTitle: "You're Premium!",
    activeDesc: 'You have access to all ThinkTwice premium features.',
    manageButton: 'Manage Subscription',
    cancelButton: 'Cancel Subscription',
    cancelConfirmTitle: 'Cancel subscription?',
    cancelConfirmMessage: 'You will lose access to premium features.',
    cancelConfirmYes: 'Cancel subscription',
    cancelConfirmNo: 'Keep Premium',
  },
};
